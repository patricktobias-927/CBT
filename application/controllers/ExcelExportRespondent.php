...
class ExcelExportRespondent extends CI_Controller {
 
 function index()
 {
  $this->load->model("ExcelExportRespondentModel");
...
//   $this->load->view("bulk_upload_of_students", $data);
 ...
 public function action()
 {
  ...
  $data = $this->ExcelExportRespondentModel->fetch_data();
...
// $Testingdate1 = "21-07-2021";
  ...
  header('Content-Disposition: attachment;filename="Respondent_Template_All.xls"');
