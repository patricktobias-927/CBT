        ...
        <div class="container-fluid">  
            <div class="row">
                <div class="col-12">  
                    ...
                    <button type="submit" id="delete_button" name="bulk_delete_submit" value="DELETE" class="btn btn-danger" style="margin-left: 515px;width:15%; margin-top:-160px;">Delete</button>
                    <div class="form-group">
                    <br> 
