<?php
class ExcelExportRschoolModel extends CI_Model
{
 function fetch_data()
 {
$sid = $this->input->post('select_code2');
...
FROM `cbt_students` s LEFT JOIN cbt_add_section ad ON (s.section_id = ad.section_id) WHERE s.school_code = '".$sid."' ORDER BY s.LRN;");
