...
class Excel_Reslrn extends CI_Controller {
 
 function index()
 {
  $this->load->model("ExcelExportRespondentLrnModel");
...
//   $this->load->view("bulk_upload_of_students", $data);
 ...
 public function action()
 {
  ...
  $data = $this->ExcelExportRespondentLrnModel->fetch_data();
...
// $Testingdate1 = "21-07-2021";
  ...
  header('Content-Disposition: attachment;filename="Respondent_Template_Per_LRN.xls"');
