...
class ExcelExportRschool extends CI_Controller {
 
 function index()
 {
  $this->load->model("ExcelExportRschoolModel");
...
//   $this->load->view("bulk_upload_of_students", $data);
 ...
 public function action()
 {
  ...
  $data = $this->ExcelExportRschoolModel->fetch_data();
...
// $Testingdate1 = "21-07-2021";
  ...
  header('Content-Disposition: attachment;filename="Respondent_Template_Per_School.xls"');
