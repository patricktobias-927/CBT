...
<div class="row">
    <div class="col-lg-12">  
           ...
           <button type="submit" name="bulk_delete_submit" value="DELETE" class="btn btn-danger" style="float:left; margin-left: 475px;width:15%; margin-top:-78px;">Delete</button>
             <div class="form-group">
