...
<?= validation_errors();?>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-1 col-sm-6"><label for="">Masterlist ID : </label>
                            <div class="col-md-6 col-sm-6">
                                <select style="" id="cbt_masterlist" name="cbt_masterlist" class="selectpicker" data-live-search="true" onchange="singleSelectChangeValue()" >
                                    <option value=""></option>
